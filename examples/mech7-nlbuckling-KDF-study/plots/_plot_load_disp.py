...
freq = 1
plt.plot(disp[0::freq], min_load[0::freq], "o-", color='tab:blue', linewidth=2)
plt.plot(disp[0::freq], avg_load[0::freq], "o-", color='tab:green', linewidth=2)
plt.plot(disp[0::freq], max_load[0::freq], "o-", color='tab:orange', linewidth=2)
